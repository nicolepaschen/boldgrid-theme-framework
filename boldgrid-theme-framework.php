...
}  else if ( 'plugins' === basename( dirname( dirname( __FILE__ ) ) ) ) {
	define( 'BGTFW_PATH', '/wp-content/plugins/boldgrid-theme-framework' );
	$theme_framework_path = __DIR__ . '/boldgrid-theme-framework';
}

$theme_framework_class = $theme_framework_path . '/includes/class-boldgrid-framework.php';
if ( file_exists( $theme_framework_class ) && ! class_exists( 'BoldGrid_Framework' ) ) {
	/**
